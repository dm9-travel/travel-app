...
class TestNav extends Component {
  ...
  render() {
    ...
    let greeting = username ? (
      <h5>Welcome {this.props.users.currentUser.user_name}!</h5>
    ) : null;
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto text-uppercase">
              ...
              {!this.props.users.currentUser.auth_id ? (
                ...
                <li className="nav-item">
                  <img
                    src={this.props.users.currentUser.user_picture}
...
export default withRouter(
  connect(mapStateToProps, { requestUser, getWatchlist })(TestNav)
);
