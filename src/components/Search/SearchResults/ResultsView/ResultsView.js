...
class ResultsView extends Component {
    ...
    render() {
        ...
        console.log('Hello from ResultsView component. USERS obj: ', this.props.users.userLocation.airport.PlaceName);
            ...
            <div>
                ...
                <div className="row">
                    ...
                    <div id="results-view" className="col-lg-6">
                        <h5 className="text-left">{ this.props.users.userLocation.airport.PlaceName } - { this.props.users.userLocation.airport.CountryName } - Number of flights available: { this.props.flights.flights.length }</h5>
